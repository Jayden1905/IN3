    ...
    <>
      <Container className="mb-14">
        <div className="relative flex justify-center gap-10">
          <div className="flex w-full flex-col gap-14 pt-10 md:w-1/2">
            <h1
              className={`select-none text-5xl font-bold leading-[3.5rem] [word-spacing:-15px] sm:text-6xl sm:leading-[4.5rem] md:tracking-wide ${headerFont}`}
            >
              Fun,reliable <br /> and
      ...
      <WaveSection>
        <div className="flex h-full w-full flex-col gap-10 px-10 md:flex-row md:px-24">
          <div className="border-dark flex flex-col justify-center border-none border-opacity-20 md:w-1/2 md:border-r">
